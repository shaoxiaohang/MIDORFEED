...
namespace vrv
{
	...
	void Array::set(int index, int)
	{}

	void Array::set(int index, unsigned int)
	{}

	void Array::set(int index, float)
	{}

	void Array::set(int index, Vector2f)
	{}

	void Array::set(int index, Vector3f)
	{}

	void Array::set(int index, Vector4f)
	{}

	void Array::set(int index, Matrix3f)
	{}

	void Array::set(int index, Matrix4f)
	{}
	...
	void ArrayUnsignedInt::set(int index, unsigned int value)
	{
		myData[index] = value;
	}
	...
	void ArrayFloat::set(int index, float value)
	{
		myData[index] = value;
	}
	...
	void ArrayVec2::set(int index, Vector2f value)
	{
		myData[index] = value;
	}
	...
	void ArrayVec3::set(int index, Vector3f value)
	{
		myData[index] = value;
	}
	...
	void ArrayVec4::set(int index, Vector4f value)
	{
		myData[index] = value;
	}
	...
	void ArrayMat3::set(int index, Matrix3f value)
	{
		myData[index] = value;
	}
	...
	void ArrayMat4::set(int index, Matrix4f value)
	{
		myData[index] = value;
	}
